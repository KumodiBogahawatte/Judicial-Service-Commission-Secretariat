...
<section class="page-hero">
    ...
    <div class="container">
        ...
        <nav class="breadcrumb">
            ...
            <span>&gt;</span>
            <span style="color: #d1b24a;">Circulars</span>
        </nav>
    </div>
</section>

<section class="circulars-section section-padding reveal">
    <div class="container">
        <div class="circulars-header">
            <div style="flex: 1; min-width: 220px;">
                <p style="color: var(--gold-accent); text-transform: uppercase; letter-spacing: 2px; font-size: 0.8rem; margin-bottom: 10px;">Circulars</p>
                <h2 style="font-size: 2.5rem; color: var(--primary-color); line-height: 1.2; margin-bottom: 8px;" class="circulars-title">Circulars Library</h2>
                <div style="width: 50px; height: 3px; background-color: var(--gold-accent); margin-bottom: 18px;"></div>
            </div>
            <div class="circulars-search-box" style="align-self: flex-end;">
                <form class="circulars-search-form">
                    <input type="text" class="circulars-search-input" placeholder="Search by Circular name or code...">
                    <button type="submit" class="circulars-search-btn">Search</button>
                </form>
                <div class="circulars-search-hint">* You can search with Circular name or Circular code</div>
            </div>
        </div>

        <div class="circulars-table-wrapper">
            <table class="circulars-table">
                <thead>
                    <tr class="circulars-table-header">
                        <th class="circulars-table-th circulars-table-th-num">#</th>
                        <th class="circulars-table-th circulars-table-th-name">Circular Name</th>
                        <th class="circulars-table-th circulars-table-th-download">Download</th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
