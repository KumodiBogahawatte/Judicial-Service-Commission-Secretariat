    ...
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 50px; flex-wrap: wrap; gap: 30px;">
        <div style="flex: 1; min-width: 300px;">
            ...
            <h2 style="font-size: 2.5rem; color: var(--primary-color); line-height: 1.2;">
                Judicial Service Commission Secretariat <span style="font-family: 'Playfair Display', serif; font-style: italic; color: var(--gold-accent);">Downloads</span>
            </h2>
            ...
            */ ?>
            <div class="download-card" style="background: #f9f7ed; border-radius: 10px; box-shadow: 0 2px 12px rgba(61,51,15,0.07); padding: 22px 18px 18px 18px;">
                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
                    ...
                    <a href="#" style="font-size: 1.13rem; color: var(--primary-color); font-weight: 600; text-decoration: underline;">Application Form for Judicial Service Commission Secretariat (2026-01-01)</a>
                ...
                <div style="color: #444; font-size: 1.01rem; margin-bottom: 8px;">Download the latest application forms, notices, and other important documents for the Judicial Service Commission Secretariat.</div>
