...
<section class="page-hero">
    ...
    <div class="container">
        <h1>Courts Directory</h1>
        <nav class="breadcrumb">
            <a href="index.php">Home</a>
            <span>&gt;</span>
            <span style="color: #d1b24a;">Courts Directory</span>
        </nav>
    </div>
</section>

<section class="courts-directory-section section-padding reveal">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 50px; flex-wrap: wrap; gap: 30px;">
        <div style="flex: 1; min-width: 300px;">
            <p style="color: var(--gold-accent); text-transform: uppercase; letter-spacing: 2px; font-size: 0.8rem; margin-bottom: 10px;">Find a Court</p>
            <h2 style="font-size: 2.5rem; color: var(--primary-color); line-height: 1.2;">Courts Directory</h2>
        ...
        <div style="flex: 1; min-width: 300px; color: #666; font-size: 0.95rem; line-height: 1.6;">
            Search for courts by province and type. Use the filters below to quickly find the court you need.
        </div>
    </div>
    <div class="container">
        <form class="courts-directory-form" style="display: flex; flex-wrap: wrap; gap: 18px 32px; align-items: flex-end; justify-content: center; margin-bottom: 36px; background: #f9f7ed; border-radius: 10px; padding: 24px 18px 18px 18px; box-shadow: 0 2px 12px rgba(61,51,15,0.07);">
        ...
        <div class="courts-directory-results" style="min-height: 120px; background: #fff; border-radius: 8px; box-shadow: 0 1px 6px rgba(61,51,15,0.04); padding: 24px 18px; text-align: left; color: #666; font-size: 1.08rem;">
