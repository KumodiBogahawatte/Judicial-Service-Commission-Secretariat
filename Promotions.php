...
<section class="page-hero">
    ...
    <div class="container">
        ...
        <nav class="breadcrumb">
            ...
            <span>&gt;</span>
            <span style="color: #d1b24a;">Promotions</span>
        </nav>
    </div>
</section>

<section class="promotions-section section-padding reveal">
    <div style="display: flex; justify-content: space-between; align-items: flex-end; margin-bottom: 50px; flex-wrap: wrap; gap: 30px;">
        <div style="flex: 1; min-width: 300px;">
            <p style="color: var(--gold-accent); text-transform: uppercase; letter-spacing: 2px; font-size: 0.8rem; margin-bottom: 10px;">Latest Promotion Notices & Documents</p>
            <h2 style="font-size: 2.5rem; color: var(--primary-color); line-height: 1.2;">
                Judicial Service Commission Secretariat <span style="font-family: 'Playfair Display', serif; font-style: italic; color: var(--gold-accent);">Promotions</span>
            </h2>
        ...
        <div style="flex: 1; min-width: 300px; color: #666; font-size: 0.95rem; line-height: 1.6;">
            Browse the latest promotion notices, letters, and downloadable documents.
        </div>
    </div>
    <div class="container">
        <!-- Placeholder for backend integration: PHP loop for documents -->
        <div class="promotions-list" style="display: flex; flex-direction: column; gap: 28px;">
            <?php /* Example PHP loop for future backend:
            foreach ($documents as $doc) {
                // $doc['title'], $doc['date'], $doc['type'], $doc['url'], $doc['desc']
            */ ?>
            <div class="promotion-card" style="background: #f9f7ed; border-radius: 10px; box-shadow: 0 2px 12px rgba(61,51,15,0.07); padding: 22px 18px 18px 18px;">
                <div style="display: flex; align-items: center; gap: 16px; margin-bottom: 8px;">
                    <i class="fas fa-file-pdf" style="color: var(--gold-accent); font-size: 1.5rem;"></i>
                    <a href="#" style="font-size: 1.13rem; color: var(--primary-color); font-weight: 600; text-decoration: underline;">Promotion List of Judicial Officers (2026-01-01)</a>
            ...
            <!-- Repeat .recruitment-card for each document/notice -->
            <?php // } ?>
        </div>
    </div>
</section>
